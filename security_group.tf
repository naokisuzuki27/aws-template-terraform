...
# ALBに対するアウトバウンドルール ##########################################################################################
resource "aws_security_group_rule" "alb_egress_ecs_basis_rule_80" {
  security_group_id = aws_security_group.alb_sg.id
  type              = "egress"
  from_port         = 80
  to_port           = 80
...
resource "aws_security_group_rule" "alb_egress_ecs_front_rule_80" {
  security_group_id = aws_security_group.alb_sg.id
  type              = "egress"
  from_port         = 80
  to_port           = 80
...
resource "aws_security_group_rule" "alb_egress_ecs_basis_rule_443" {
  security_group_id = aws_security_group.alb_sg.id
  type              = "egress"
  from_port         = 443
  to_port           = 443
...
resource "aws_security_group_rule" "alb_egress_ecs_front_rule_443" {
  security_group_id = aws_security_group.alb_sg.id
  type              = "egress"
  from_port         = 443
  to_port           = 443
